...
import { getTheme, setTheme as saveTheme } from '@/lib/storage'; // Import theme functions
...
const Settings = () => {
  ...
  const [isDarkMode, setIsDarkMode] = useState(getTheme() === 'dark'); // State for Dark Mode
  ...
  return (
    <div key={`settings-${currentLanguage}`} className="space-y-4 md:space-y-6">
      {/* Header */}
      <motion.div
            ...
            <div className="space-y-2">
              ...
              <select
                ...
                onChange={async (e) => {
                  ...
                  // 2. Change i18n language (triggers global re-render)
                  ...
                  try {
                    ...
                    // 4. Revert language change if save fails
